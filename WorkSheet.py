...
with placeholder.form("login"):
    ...
    round_ = st.selectbox("รอบที่",["1","2"])
    ...
    if c001.button("Submit"):
        ...
        if N1!="" and N2!="" and N3!="" and E1!="" and E2!="" and E3!="" and N3!="" and E1!="" and E2!="" and E3!="" and H1!="" and H2!=""and H3!="" and parcel_no!="" and survey_no!="" and land_no!="" and UTMMAP1!="" and UTMMAP3!="" and BND_NAME!="" :
            ...
            if image_1 and image_2 and image_3:
                ...
                row = [parcel_no, survey_no, province, amphoe, tambon, UTMMAP1, UTMMAP2, UTMMAP3, UTMMAP4, Scale, land_no, Name, round_, BND_NAME, N, E, H, Method, date.strftime('%d/%m/%Y'), remark, N1, E1, H1, N2, E2, H2, N3, E3, H3,image_id[0],image_id[1],image_id[2]]
                row_update = wks.append_row(values=row,value_input_option="USER_ENTERED")
                row_update['updates']['updatedRange']
                DATE_temp = wks.acell('R'+row_update['updates']['updatedRange'][6:]).value.replace('\xa0',' ').split()
